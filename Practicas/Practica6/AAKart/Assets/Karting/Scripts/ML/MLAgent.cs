...
public class MLPModel
{
    ...
    public float[] FeedForward(Perception p, Transform transform)
    {
        ...
        // Realizar la propagaci�n hacia adelante
        for (int i = 0; i < mlpParameters.getCoefficientsCount(); i++)
        {
            ...
            // Aplicar la funci�n de activaci�n (por ejemplo, sigmoide)
    ...
    {
        // Implementa aqu� tu funci�n de activaci�n (por ejemplo, sigmoide)
        // Puedes usar la funci�n Mathf.Clamp01 para limitar los valores entre 0 y 1
